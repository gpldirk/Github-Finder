...
const User = (props) => {
  ...
  const { getUser, user, loading, repos, getUserRepos } = githubCtx;
  ...
  const {
    ...
    followers, following, public_repos, company, login,
    ...
    <Fragment>
      ...
      <div className='card grid-2'>
        <div className='all-center'>
          <img src={avatar_url} className='round-img'  style={{width: '150px'}} alt="avatar_url" />
